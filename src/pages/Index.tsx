    ...
    <main className="relative h-screen w-full overflow-hidden bg-background">
      ...
      >
        ...
        <div className="hidden items-center gap-8 md:flex">
          {["Главная", "Вакансии", "Направления", "О службе", "Контакты"].map((item, index) => (
            <button
              key={item}
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="mb-6 animate-in fade-in slide-in-from-bottom-8 font-sans text-6xl font-light leading-[1.1] tracking-tight text-foreground duration-1000 md:text-7xl lg:text-8xl">
              <span className="text-balance">
                Служи стране.
                <br />
                <span className="text-foreground/45">Работай удалённо.</span>
              </span>
            </h1>
            <p className="mb-8 max-w-xl animate-in fade-in slide-in-from-bottom-4 text-lg leading-relaxed text-foreground/90 duration-1000 delay-200 md:text-xl">
              <span className="text-pretty">
                Официальная платформа трудоустройства в государственные структуры с возможностью удалённой работы из любой точки страны.
              </span>
            </p>
